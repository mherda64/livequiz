...
function connect() {
    var socket = new SockJS('/liveQuiz-websocket');
...
function getCurrentVotingSession() {
    stompClient.send("/app/votingSession/current", {}, JSON.stringify({}));
}
...
$(function () {
    ...
    $( "#updateVotingSession" ).click(function() { getCurrentVotingSession(); });
});
